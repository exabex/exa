...
const SUPPORT_EMAIL = 'support@exchange.mktcoin.dev';
const NOREPLY_EMAIL = 'no-reply@exchange.mktcoin.dev';
const DOMAIN = 'shorelinecrypto.com';

const MAILER_NAME = 'Exabex Mailer';
const START_MESSAGE = 'Exabex started!';
...
exports.recaptcha_pub_key = "6LcWqDQhAAAAADN6IzAq_UeXTk7-NOj_IvE3ALax"; // Recaptcha Pub Key v2
