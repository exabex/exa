...
let transporter = nodemailer.createTransport({
    host: "ssr7.supercp.com",
    port: 465,
    secure: true, // use TLS
    auth: {
        user: "support@exchange.mktcoin.dev",
        pass: "siria2022",
    },
    tls: {
...
exports.SendSignupConfirmation = function(email, url, urlCheck, callback) {
    ...
    const body =
        ...
        "<p>Welcome to ShorelineCrypto!</p><br>Best Regards,</br>ExabexTeam";

    try {
        let isSent = false;
        transporter.sendMail({
                from: 'ExabexMailer <' + g_constants.NOREPLY_EMAIL + '>',
...
exports.SendPasswordResetConfirmation = function(email, user, url, urlCheck, callback) {
    ...
    const body =
        ...
        "<p>Someone requested that the password for your Exabexaccount be reset</p>" +
        "<p>" + confirmHREF + "</p>" +
        ...
        "<p>This is an automated message. Please, do not reply to it.</p>" +
        "</br></br>Best Regards,<br>ExabexTeam";
...
exports.SendWithdrawConfirmation = function(email, user, url, urlCheck, callback) {
    ...
    const body =
        "<h3>Hello " + unescape(user) + "</h3>" +
        "<p>Someone requested withdraw from your Exabexbalance</p>" +
        "<p>" + confirmHREF + "</p>" +
